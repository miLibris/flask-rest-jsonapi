...
from flapison.exceptions import InvalidFilters
from flapison.schema import get_relationships, get_model_field
...
class Node(object):
    ...
    def resolve(self):
        ...
        if (
            ...
            elif isinstance(self.column.prop, RelationshipProperty) and isinstance(
                value, (int, str)
            ):
